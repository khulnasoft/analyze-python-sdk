...
class SubAnalysis:
    """
    SubAnalysis is a class representing a sub-analysis object in an Khulnasoft API.
    """
    def __init__(self,
                 analysis_id: str,
    ...
    def from_analysis_id(cls,
                         ...
                         composed_analysis_id: str,
                         lazy_load=True,
                         api: KhulnasoftApiClient = None) -> Optional['SubAnalysis']:
        """
        class method that creates a new instance of the class by fetching the details of the sub-analysis from the Khulnasoft API.
