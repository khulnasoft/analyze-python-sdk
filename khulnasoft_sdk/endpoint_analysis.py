...
class EndpointAnalysis(Analysis):
    """
    EndpointAnalysis is a class for analyzing endpoints. It is a subclass of the Analysis class and requires an API connection to Khulnasoft.
    ...
    def __init__(self,
        ...
        :param scan_api: The API connection to Khulnasoft for endpoint scans.
    ...
    @classmethod
    def from_analysis_id(cls, analysis_id: str, api: KhulnasoftApiClient = None):
        """
        ...
        """
        response = KhulnasoftApi(api or get_global_api()).get_endpoint_analysis_response(analysis_id, True)
...
def download_endpoint_scanner(platform: str = None,
    ...
    return KhulnasoftApi(api).download_endpoint_scanner(platform, path, output_stream)
