...
def get_alerts_by_alert_ids(alert_ids: List[str],
                            ...
                            api: KhulnasoftApi = None) -> Tuple[int, List[dict]]:
    """
    ...
    """
    api = KhulnasoftApi(api or get_global_api())
...
def query_alerts_history(*,
    ...
    :param api: Instance of Khulnasoft API for request server.
...
class Alert:
    """
    The Alert class is used to represent an alert from the Khulnasoft Analyze API.
    ...
    :vartype sender: str
    :ivar khulnasoft_alert_url: URL for the alert in Khulnasoft's website.
    :vartype khulnasoft_alert_url: str
    ...
    def __init__(self,
        ...
        Please note that this does not query the Khulnasoft Analyze API for the alert data, but rather creates an Alert
        ...
        self._khulnasoft_api_client = api
        ...
        self.khulnasoft_alert_url: Optional[str] = None
    ...
    def check_status(self) -> AlertStatusCode:
        """
        Refresh the alert data from the Khulnasoft Analyze API - overrides current data (if exists) with the new data.
        ...
        self.khulnasoft_alert_url = alert.get('khulnasoft_alert_url')
    ...
    def from_id(cls,
        ...
        """
        Create a new Alert instance, and fetch the alert data from the Khulnasoft Analyze API.
    ...
    def send(cls,
        ...
        """
        Send an alert for further investigation using the Khulnasoft Analyze API.
        ...
        """
        _api = KhulnasoftApi(api or get_global_api())
    ...
    def send_phishing_email(cls,
                            ...
                            api: Optional[KhulnasoftApiClient] = None,
                            environment: Optional[str] = None,
                            default_verdict: Optional[str] = None,
                            alert_sender: Optional[str] = None,
                            wait: bool = False,
        ...
        def _fetch_scan(scan_: dict,
            ...
            if current_analysis_id:
                self.scans.append(scan_object.from_analysis_id(analysis_id=current_analysis_id,
                                                               api=self._khulnasoft_api_client))
