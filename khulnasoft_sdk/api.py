...
class KhulnasoftApi(KhulnasoftApiClient):
    def __init__(self,
                 api_version: str = None,
                 api_key: str = None,
                 base_url: str = None,
    ...
    @deprecated('KhulnasoftApi is deprecated and will be removed in the future')
    ...
    def get_url_result(self, url: str) -> dict:
        ...
        if 'error' in response_json:
            raise errors.KhulnasoftError('response error: {}'.format(response_json['error']))
...
def get_global_api() -> KhulnasoftApi:
    """
...
def set_global_api(api_key: str = None,
                   ...
                   verify_ssl: bool = True,
                   on_premise_version: OnPremiseVersion = None,
                   proxies: Dict[str, str] = None) -> KhulnasoftApiClient:
    """
    ...
    """
    global _global_api
    api_key = api_key or os.environ.get('KHULNASOFT_ANALYZE_API_KEY')
    _global_api = KhulnasoftApi(api_version=api_version or consts.API_VERSION,
                             api_key=api_key,
...
def set_global_api_custom_instance(api: KhulnasoftApiClient) -> KhulnasoftApiClient:
    """
...
KhulnasoftProxy = KhulnasoftApiClient
