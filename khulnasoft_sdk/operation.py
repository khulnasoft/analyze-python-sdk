...
class Operation:
    """
    The Operation class is used to represent an asynchronous operation with the Khulnasoft API.
    """

    def __init__(self, url: str, name: str, api: KhulnasoftApiClient = None):
        """
