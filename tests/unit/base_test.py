...
class ApiSpec(unittest.TestCase):
    ...
    def test_is_khulnasoft_site_available(self):
        # Arrange
        api = KhulnasoftApiClient(base_url='', api_version='')
    ...
    def test_is_khulnasoft_site_available_website_not_available(self):
        # Arrange
        api = KhulnasoftApiClient(base_url='', api_version='')
        api.full_url = self.full_url
        with responses.RequestsMock() as mock:
    ...
    def test_is_khulnasoft_site_available_server_no_response(self):
        # Arrange
        api = KhulnasoftApiClient(base_url='', api_version='')
        api.full_url = self.full_url
        with responses.RequestsMock() as mock:
